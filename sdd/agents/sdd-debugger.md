---
name: sdd-debugger
description: "Use this agent when verification or QA validation fails during SDD workflow execution. This agent diagnoses what went wrong, identifies root causes, and creates a targeted fix plan. It is spawned automatically by execute-phase and verify-work commands when issues are detected.\n\nExamples:\n\n- Context: QA validator found that 3 out of 7 requirements were not met after plan execution.\n  assistant: \"Verification found issues. Launching sdd-debugger to diagnose and create a fix plan.\"\n  <Task tool launched with sdd-debugger agent>\n\n- Context: Plan executor failed on Task 4 with a test failure.\n  assistant: \"Task 4 failed. Let me launch the sdd-debugger to investigate the failure and propose a fix.\"\n  <Task tool launched with sdd-debugger agent>\n\n- Context: User reports issues during UAT verification.\n  assistant: \"Let me use the sdd-debugger to investigate these issues and create a fix plan.\"\n  <Task tool launched with sdd-debugger agent>"
