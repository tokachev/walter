...
Execute the following command using the Bash tool. First verify codex is available with `command -v codex`. If codex is not found or the command fails, skip to Merge Research and note degraded mode.
